...
if($_SESSION['status'] == 'invalid'){
    $_SESSION['status'] = 'invalid';
    echo "<script>window.location.href = '/webstay/adminlogin.php'</script>";
}
...
<head>
  ...
  <title>WebStay: Admin Dashboard</title>
</head>
<body>
  <div class="sidebar">
    <div class="header-text">
      <img src="./images/logo1.png" alt="">
      <h2>WebStay Admin Dashboard</h2>
    </div>
    <div class="lists">
      <!-- <div class="link" id="mainBtn">
